            ...
            for table_item in course_time_dict.get(time):
                ...
                if table_item.other_event:
                    ...
                    node = {'course_table_id': table_item.id,
                            ...
                            'teacher_id': table_item.teacher.id if table_item.teacher else '',
                            'teacher': table_item.teacher.last_name + table_item.teacher.first_name if table_item.teacher else '',
                            'week': week,
                            'class_id': class_id,
                            'position': position,
                            'is_event': False,
