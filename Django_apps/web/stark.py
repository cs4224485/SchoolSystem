...
from school.models import TableSettings, TableInfo, QuestionBank
...
from Django_apps.web.views.question_bank import QuestionBankConfig
...
site.register(QuestionBank, QuestionBankConfig)
