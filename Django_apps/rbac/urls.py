...
from Django_apps.rbac.views import Role, user
from Django_apps.rbac.views import menu
...
urlpatterns = [
    ...
    url(r'^user/list/$', user.user_list, name='user_list'),  # rbac:role_list
    url(r'^user/add/$', user.user_add, name='user_add'),  # rbac:role_add
