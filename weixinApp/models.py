...
class WechatUserInfo(models.Model):
    ...
    status = models.SmallIntegerField(verbose_name='账号状态', choices=status_choice)
...
class WechatBindInfo(models.Model):
    ...
    school_id = models.ForeignKey(verbose_name='学校ID', to='school.SchoolInfo', on_delete=models.CASCADE)
