...
class StudentInfo(models.Model):
    ...
    residence_province = models.CharField(verbose_name='户籍省', max_length=16, null=True)
    residence_city = models.CharField(verbose_name='户籍市', max_length=16, null=True)
    residence_region = models.CharField(verbose_name='户籍县区', max_length=16, null=True)
    birthday = models.DateField(verbose_name='生日', null=True)
    age = models.IntegerField(verbose_name='年龄', null=True)
    day_age = models.IntegerField(verbose_name='日龄', null=True)
    constellation_choice = (
        (1, "摩羯"), (2, "水瓶"), (3, "双鱼"), (4, "白羊"), (5, "金牛"), (6, "双子"), (7, "巨蟹"), (8, "狮子"), (9, "处女"), (10, "天秤"),
        (11, "天蝎"), (12, "射手"))
    constellation = models.IntegerField(verbose_name='星座', choices=constellation_choice, null=True)
