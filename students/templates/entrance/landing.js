...
(function ($, doc) {
    ...
    $.ready(function () {
        ...
        var BloodTypeButtons = doc.getElementById('BloodTypes');
        BloodTypeButtons.addEventListener('tap', function (event) {
            userPicker.show(function (items) {
                BloodTypeButtons.value = items[0].text;
                personalState.classess = items[0].value
            });
        }, false);
        ...
        mui.ajax({
            ...
            success: function (data) {
                ...
                if (data.state) {
                    mui.alert(data.msg);
                    setTimeout(function () {
                        window.location.href = "index3.html?student_id=" + urlId
                    }, 1500)
                } else {
                    mui.alert(data.msg)
                }
